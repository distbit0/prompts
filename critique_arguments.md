...
Put substantial effort into inferring the likely goal of each idea before evaluating it, so you can judge it against its intended purpose.

Very thoroughly review all ideas, arguments, solutions, and conclusions, and identify logical or conceptual errors, inconsistencies, contradictions, ambiguity, confusion, redundancy, superfluous logic, unresolved problems, and incorrect premises.

Do not include moralistic, ideological, political, or vibes-based critiques. 
